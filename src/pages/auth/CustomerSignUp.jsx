...
<div className="Get-started">
        ...
        <Col xs={12} md={6} className="d-flex align-items-center justify-content-center py-5 py-md-0 right-side">
          <div className="auth-right-panel w-100" style={{ maxWidth: 420 }}>
            <h3 className="fw-bold mb-1 text-center">Sign Up Account</h3>
            ...
            <Form>
              <Row className="g-3">
                <Col sm={6}>
                  ...
                  <Form.Control placeholder="eg. John" aria-label="First name" />
                </Col>
                <Col sm={6}>
                  <Form.Label>Last Name</Form.Label>
                  <Form.Control placeholder="eg. Francisco" aria-label="Last name" />
                </Col>
              </Row>

            <div className="mt-3">
                <Form.Label>Email</Form.Label>
                <Form.Control placeholder="eg. johnfrans@gmail.com" type="email" />
            </div>
            <div className="mt-3">
    ...
    <InputGroup className="rounded-input-group">
      ...
      >
        <Eye />
              ...
              <Button variant="primary" className="gradient-btn w-100" type="submit">
                Sign Up
              </Button>
            </Form>

            <p className="small text-center mt-4">
              Already have an account? <a href="/auth/customer/sign-in">Log in</a>
            </p>
          </div>
        </Col>
      </Row>
